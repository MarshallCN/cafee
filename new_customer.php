...
<table>
	...
	<tr>
		...
		<td class='width-2'>
			<input type='text' maxlength='6' value=<?php echo "'$newnum'";?> disabled='disabled'/>
		</td>
		<td class='bold' class='width-2'>Customer ID<span class="req"> *</span></td>
		<td class='width-2'>
			<input type='text' name='newid' value=<?php echo "'$newid'";?> required/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class='bold'>
			<row>
				<column cols='6'>Birthday Date</column>
		</td>
		<td>
			<column cols='6'>
				<row end>
	...
	<tr>
		...
		<td>
			<textarea name='addr' rows='3' class='width-12' maxlength='50'></textarea>
		</td>
	</tr>
</table>
